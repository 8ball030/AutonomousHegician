...
from packages.eightballer.skills.option_monitoring.dex_wrapper import DexWrapper
from packages.eightballer.skills.option_monitoring.web_server import run_server
...
#           return
        for order in orders_to_create:
            self._request_contract_interaction(
                order.market.lower()+"options", "create_option", {
                    "period": order.period,
                    "amount": order.amount,
